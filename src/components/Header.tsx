...
export default function Header({ userName, balance, hasUnreadPrize }: HeaderProps) {
    return (
        <header className="bg-red-600 text-white p-4 pb-12 rounded-b-[2rem] shadow-lg relative">
            ...
            <div className="flex justify-between items-end">
                ...
                <button className="bg-white text-red-600 px-6 py-2 rounded-full font-bold shadow-md active:scale-95 transition-transform">
                    Recargar
                </button>
            </div>
